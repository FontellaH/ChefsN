...
using Microsoft.EntityFrameworkCore;
 namespace ChefsN.Models;  // ********* #1 its not yourprojectname... change to Pet or your model class name **************
...
{   
    ...
    public DbSet<Chef> Chefs { get; set; } //********* #2 Change from Monster to <Pet> model file... i will name my table for sql Pets
